% "{'chapitre':'dyn_1d','classe':('PSI'),'type':('cours'),'titre':'Résolution des problèmes de dynamique plans à une mobilité','source':'','comp':('DYN-05','DYN-06')}"
...
\section[Première approche du PFD]{Première approche du Principe Fondamental de la Dynamique}
...
$\vectrd{E}{R_0} = m_E\vectg{G}{E}{R_0}$. $G$ désisgne le centre d'inertie de $E$. }
...
\begin{resultat}[Relation de Varignon]
...
\marginnote{Le comoment des torseurs est défini par :
...
\marginnote{\begin{warn}
Il faudra bien veiller à ce que chacun des torseurs soit exprimé en un même point pour effectuer le comoment.
\end{warn}}

\begin{defi}[Expression avec les comoments]
