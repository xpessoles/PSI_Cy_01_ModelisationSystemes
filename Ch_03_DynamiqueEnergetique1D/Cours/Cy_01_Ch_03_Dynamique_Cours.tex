...
\begin{definition}\textbf{\textsf{\small -- Énoncé du Principe Fondamental de la Dynamique}} ~\\
...
\begin{theorem}\textbf{\textsf{\small --Théorème de l'énergie cinétique}} 
...
\begin{minipage}[c]{.48\linewidth}
\begin{center}
\includegraphics[width=.9\linewidth]{trapeze}
\end{center}
\end{minipage}
\begin{resultat}
