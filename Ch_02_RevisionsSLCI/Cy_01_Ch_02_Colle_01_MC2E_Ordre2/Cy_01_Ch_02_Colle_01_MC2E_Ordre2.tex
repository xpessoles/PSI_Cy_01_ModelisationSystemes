% "{'chapitre':'slci_laplace','classe':('PSI'),'type':('td','colle'),'titre':'Micromanipulateur compact pour la chirurgie endoscopique', 'source':'Concours Mines Ponts 2016','comp':['B2-04',],'corrige':True}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_01_Ch_02_Colle_01_qr}
\end{marginfigure}
\fi
