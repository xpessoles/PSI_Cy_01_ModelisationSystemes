% "{'chapitre':'slci_synthese','classe':('PSI'),'type':('td'),'titre':'Robot pour la chirurgie endoscopique', 'source':'Banque PT - SIA - 2005','comp':(None),'corrige':True}"
...
\marginnoteBanque PT -- SIA -- 2005 2005.}
