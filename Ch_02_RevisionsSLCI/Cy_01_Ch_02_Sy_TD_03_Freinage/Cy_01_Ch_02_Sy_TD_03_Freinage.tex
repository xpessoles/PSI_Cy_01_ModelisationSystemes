...
Système de freinage d’un TGV DUPLEX -- \ifprof Corrigé \else Sujet \fi}

\addcontentsline{toc}{section}{TD \arabic{cptTD} : Système de freinage d’un TGV DUPLEX -- \ifprof Corrigé \else Sujet \fi}
