% "{'chapitre':'slci_synthese','classe':('PSI'),'type':'td','titre':'Bateau support de ROV', 'source':'Concours Centrale Supelec - MP 2019','comp':['SLCI-02','SLCI-09','SLCI-11'],'corrige':True }"
...
\marginnote{\textit{Concours Centrale Supelec -- MP 2019.}}
\marginnote{\xpComp{SLCI}{02}\xpComp{SLCI}{09}\xpComp{SLCI}{11}}
...
\hline
\end{tabular}
\captionof{table}{Volumes $V_{G0}$ pour différents réglages du PHC}
\label{tab2}
\end{center}
