% "{'chapitre':'slci_blocs','classe':('PSI'),'type':('td'),'titre':'Cellule d\\'assemblage pour avion Falcon', 'source':'Concours E3A - PSI 2015','comp':('B2-07','C2-03','SLCI-02','SLCI-03','SLCI-09','SLCI-11'),'corrige':True}"
...
\marginnote{\xpComp{SLCI}{02}\xpComp{SLCI}{03}\xpComp{SLCI}{09}\xpComp{SLCI}{11}}
...
\item $C_M (t)=K_C i(t)$ ;
\item $\indice{J}{eq}  \dfrac{d\omega_m(t)}{\text{d} t}+f\omega_m (t)=C_M (t)-C_R (t)$.
\end{itemize}
...
\caption{Réponse temporelle système réglé. \label{fig:image11}}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_01_Ch_02_03_TD_02_qr}
\end{marginfigure}
\fi
