...
\marginnote[3cm]{De manière générale on note 
...
\marginnote[1cm]{En dehors des conditions de Heaviside, la transformée de Laplace d'une dérivée première est donnée par $\mathcal{L}\left[ \dfrac{\dd f(t)}{\dd t}\right] =pF(p)-f(0^+)$.}
