% "{'chapitre':'slci_revisions','classe':('PSI'),'type':('cours'),'Rappels sur la modélisation des systèmes asservis','source':'','comp':('B2-02','B2-05','B2-06','B2-07','C1-01','C2-01','C2-02','C2-03'),'corrige':True}"
