...
\begin{center}
\includegraphics[width=.9\linewidth]{CAN_CNA}
\end{center}
...
%\centering
\begin{center}
\includegraphics[width=.9\linewidth]{perf_v2.pdf}
\captionof{figure}{Performances sur une réponse à un échelon.}
%\end{figure}
\end{center}


\begin{defi}[Amortissement]
L'amortissement caractérise la capacité d'un système à réduire ses oscillations lorsqu'il est soumis à une entrée ou à une perturbation. 
Il est caractérisé par le dépassement. 
On peut le définir par $D_{\%} = \dfrac{\indice{s}{max} - s_{\infty} }{\indice{s}{\infty} - s_{0}}$.
\end{defi}
