% "{'chapitre':'slci_blocs','classe':('PSI'),'type':('td'),'titre':'Asservissement par traitement d’image d’une plateforme Hexapode', 'source':'Concours Centrale Supelec PSI 2016','comp':[],'corrige':False}"
