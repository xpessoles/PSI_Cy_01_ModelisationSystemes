% "{'chapitre':'slci_laplace','classe':('PSI'),'type':('td','colle'),'titre':'Tour en fosse utilisé pour le reprofilage des roues ferroviaires', 'source':'Concours Centrale Supelec - PSI 2018','comp':('B2-04'),'corrige':True}"
