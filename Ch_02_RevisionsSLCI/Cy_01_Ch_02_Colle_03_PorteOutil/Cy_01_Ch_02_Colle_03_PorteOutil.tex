...
\addcontentsline{toc}{section}{\ifcolle Colle \arabic{cptColle}  \else TD \arabic{cptTD} \fi  : Tour en fosse utilisé pour le reprofilage des roues ferroviaires -- Asservissement du porte-outil  -- \ifprof Corrigé \else Sujet \fi}
