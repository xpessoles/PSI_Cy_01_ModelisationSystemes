...
\addcontentsline{toc}{section}{Colle \arabic{cptColle} : Tour en fosse utilisé pour le reprofilage des roues ferroviaires -- Asservissement du porte-outil  -- \ifprof Corrigé \else Sujet \fi}
