% "{'chapitre':'slci_laplace','classe':('PSI'),'type':('td'),'titre':'Assistance pour le maniement de charges dans l’industrie','source':'Concours Centrale Supelec TSI 2017','comp':[],'corrige':True}"
