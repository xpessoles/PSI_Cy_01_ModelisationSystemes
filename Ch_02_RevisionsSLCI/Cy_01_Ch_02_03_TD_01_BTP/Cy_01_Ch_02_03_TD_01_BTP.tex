...
\caption{Représentation de la BTP}
\end{marginfigure}
...
\begin{figure}[!h]%
    \centering
    \subfloat[\centering Hélicoptère. \label{btp_fig_03}]{{\includegraphics[width=.47\linewidth]{fig_03} }}%
    \subfloat[\centering Structure du banc d'essai. \label{btp_fig_04}]{{\includegraphics[width=.47\linewidth]{fig_04} }}%
   \caption{Hélicoptère et banc dessai}%
	   \label{fig:04}%
\end{figure}
\fi
...
\item $K_1=\dfrac{K_{\text{Adapt}} K_P}{K+K_P K_{\text{Capt}}}$	et	$\tau_1=\dfrac{R I_{\text{eq}}}{K^2+K K_P K_{\text{Capt}}}$,  $K_2=\dfrac{R}{K \left(K+K_P  K_{\text{Capt}} \right) }$	et	$\tau_2=\tau_1=\dfrac{R I_{\text{eq}}}{K (K+K_P K_{\text{Capt}} ) }$ et 
