% "{'chapitre':'slci_blocs','classe':('PSI'),'type':('td'),'titre':'Banc d\\'essai BTP','source':'Concours CCINP - TSI 2015','comp':('B2-07','C2-03'),'corrige':True}"
...
\marginnote{Concours CCINP -- TSI 2015}
...
\centering
\fancyqr{http://xpessoles-cpge.fr/pdf/Cy_01_Ch_02_03_TD_01_BTP_Corrige.pdf}
\end{marginfigure}
\fi
