...
\marginnote{En utilisant la figure précédente, on lit un gain maximal de \SI{30}{dB} soit $\indice{A}{max}=10^{1,5}$ et on a un gain de $K=10$. $\xi$ est solution de $10^{1,5} \times 2\xi\sqrt{1-\xi^2} - 10$.}
