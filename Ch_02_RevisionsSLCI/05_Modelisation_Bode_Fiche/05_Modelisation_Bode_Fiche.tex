...
\end{scope}
\begin{scope}[yshift=-1.5cm,yscale=1/50]
\UniteDegre
\OrdBode{30}
\semilog{-2}{2}{-30}{30}
...
\begin{scope}[yscale=3/50]
\semilog{-2}{2}{0}{20}
\BodeAmp[thick,cyan]{-2:2}{\KAmp{10}}
\draw (0,8) node [above] {\footnotesize $20 \log K$};
\end{scope}
...
\tikzset{
semilog lines/.style={thin, bleuxp}, 
semilog lines 2/.style={semilog lines,bleuxp},
semilog half lines/.style={semilog lines 2,dotted },
...
\tikzset{
semilog lines/.style={thin, bleuxp}, 
semilog lines 2/.style={semilog lines,bleuxp!50},
semilog half lines/.style={semilog lines 2,dotted },
semilog label x/.style={semilog lines,below,font=\tiny},
semilog label y/.style={semilog lines,right,font=\tiny}
}
