...
\begin{itemize}
\item Fonction de transfert : $H(p)=\dfrac{K}{1+\dfrac{2\xi}{\omega_0}p+\dfrac{p^2}{\omega_0^2}}$.
\end{itemize}
\begin{center}
\textbf{Cas où $\xi<1$.}
\end{center}
...
\item Diagramme de gain  : gain nul.
\item Diagramme de phase : $\text{arg}\left( H(p) \right)=-T\omega$.
\end{itemize}
\end{resultat}
